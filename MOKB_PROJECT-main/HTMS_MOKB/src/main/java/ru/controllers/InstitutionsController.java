...
//    @GetMapping("/all")
//    public ResponseEntity<List<Institutions>> getAllInstitutions() {
//        List<Institutions> institutions = institutionsService.getAllInstitutions();
//        return ResponseEntity.ok(institutions);
//    }

    @GetMapping("/institutions")
    public ResponseEntity<List<InstitutionsDTO>> findAllInstitutions() {
        List<InstitutionsDTO> institutions = institutionsService.getAllInstitutions();
        return ResponseEntity.ok(institutions);
    }
