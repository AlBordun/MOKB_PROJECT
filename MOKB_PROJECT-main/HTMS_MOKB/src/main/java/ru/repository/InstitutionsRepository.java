...
//    List<Institutions> findAll();
    ...
    // Аналогично для институтов
//    @Query("SELECT i.inst_id, i.instName FROM Institutions i WHERE i.instName IS NOT NULL AND TRIM(i.instName) <> ''")
//    List<Object[]> findDistinctInstNames();
}
