...
const FormModal: React.FC<FormModalProps> = ({show, onClose, onSave, patient, copyData}) => {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        setFormData({...formData,id: '',refType: "", address: "",realAddress: "", dateOfBirth: "", directionNumber: "", documentType: "", firstName: "", gender: "", lastName: "", passportNumber: "", passportSeries: "", middleName: "", policyNumber: "", populationCategory: "", referralDate: "", snils: "", [name]: value});
