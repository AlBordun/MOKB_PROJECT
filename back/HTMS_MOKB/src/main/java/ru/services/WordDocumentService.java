...
//    public byte[] convertWordToPdf(byte[] docContent) throws IOException {
//        try (XWPFDocument doc = new XWPFDocument(new ByteArrayInputStream(docContent));
//             ByteArrayOutputStream out = new ByteArrayOutputStream()) {
//
//            // Создание объекта PdfOptions
