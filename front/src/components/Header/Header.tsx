...
const Header: React.FC<HeaderProps> = ({onProtocolClick, onReferralClick, onTicketClick, searchText,setSearchText}) => {
    ...
    const toggleColumnVisibility = (column: keyof Patient) => {
        console.log("column visibility: ", column);
        console.log("column visibility: ", columnVisibility);
    ...
    //     return (
    //         <button className={`menu ${isOpen ? 'opened' : ''}`} onClick={toggleMenu} aria-expanded={isOpen} aria-label="Main Menu">
        ...
        <>
            ...
            <div className="flex flex-row justify-start">
                <Toolbar sx={{
                    ...
                    <button className={`menu ${isOpen ? 'opened' : ''}`} onClick={toggleMenu} aria-expanded={isOpen}
