...
const Header: React.FC<HeaderProps> = ({
    ...
    const initialFormData: Form = {
        ...
        accomp_middle_name: '',
        accomp_gender: 0,
        accomp_document_type: 0,
        accomp_passport_series: 0,
        accomp_passport_number: 0,
    ...
    const handleDeletePatients = () => {
        deletePatients(selectedPatients)
            .then(() => {
                onPatientsDeleted(); // Вызываем callback после успешного удаления
            })
            .catch(error => console.error("Ошибка при удалении пациентов:", error));
    };
