...
const NewPatientsTable: React.FC<newPatientsTableProps> = ({searchText,setSearchText}) => {
    ...
    const filteredPatients = patients.filter(patient =>
        ...
        patient.middle_name.toLowerCase().includes(searchText.toLowerCase()) ||
        patient.date_of_birth.toLowerCase().includes(searchText.toLowerCase()) ||
        patient.gender.toLowerCase().includes(searchText.toLowerCase()) ||
        patient.population_category.toLowerCase().includes(searchText.toLowerCase()) ||
        patient.passport_series.toLowerCase().includes(searchText.toLowerCase()) ||
        patient.population_category.toLowerCase().includes(searchText.toLowerCase()) ||
        patient.passport_number.toLowerCase().includes(searchText.toLowerCase()) ||
        patient.registration_address.toLowerCase().includes(searchText.toLowerCase()) ||
        patient.actual_address.toLowerCase().includes(searchText.toLowerCase()) ||
        patient.snils.toLowerCase().includes(searchText.toLowerCase()) ||
        patient.insurance_policy.toLowerCase().includes(searchText.toLowerCase())
    );
