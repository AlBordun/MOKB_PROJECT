...
const FormModal: React.FC<FormModalProps> = ({show, onClose, onSave,onSaveData, patient,form}) => {
    ...
    // const handleOpenPatientForm = async (patientId) => {
    //     try {
    //         const patientData = await fetchPatientData(patientId); // Запрос данных пациента
    //         const formData = await fetchFormData(patientId);      // Запрос данных формы
    //         setCombinedData({ patientData, formData });
    //     } catch (error) {
